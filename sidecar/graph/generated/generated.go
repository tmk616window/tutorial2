...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "chatUsersResponse.user":
		if e.complexity.ChatUsersResponse.User == nil {
			break
		}

		return e.complexity.ChatUsersResponse.User(childComplexity), true
...
func (ec *executionContext) fieldContext_Query_getChatUsers(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "user":
				return ec.fieldContext_chatUsersResponse_user(ctx, field)
			case "latestMessage":
...
func (ec *executionContext) _chatUsersResponse_user(ctx context.Context, field graphql.CollectedField, obj *model.ChatUsersResponse) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_chatUsersResponse_user(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_chatUsersResponse_user(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
...
func (ec *executionContext) _chatUsersResponse(ctx context.Context, sel ast.SelectionSet, obj *model.ChatUsersResponse) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "user":
			...
			out.Values[i] = ec._chatUsersResponse_user(ctx, field, obj)
